...
<br />
## A la prochaine pour un autre patron de conception. Vous pouvez retrouver un autre
exemple, certainement mieux expliquer, avec des illustrations sur :

<a href="https://www.geeksforgeeks.org/bridge-method-python-design-patterns/" target="_blank" className="underline underline-offset-2">
    Geeks for Geeks
  </a>
...
<div>{<MyLink href={'/blog'}>Retour aux articles</MyLink>}</div>
